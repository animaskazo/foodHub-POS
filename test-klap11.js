fetch("https://api-pasarela-sandbox.mcdesaqa.cl/payment-gateway/v1/orders", {
  ...
  body: JSON.stringify({
    ...
    methods: ["tarjetas"],
    urls: {
      return_url: "https://food-admin.digital-solutions.work/order/pizza%20nostra?orderId=123&status=success",
      cancel_url: "https://food-admin.digital-solutions.work/order/pizza%20nostra"
    },
    webhooks: {
