fetch("https://api-pasarela-sandbox.mcdesaqa.cl/payment-gateway/v1/orders", {
  ...
  body: JSON.stringify({
    ...
    methods: ["tarjetas"],
    urls: {
      return_url: "http://localhost:5173/p/animaskazo?orderId=08ffceae-f0fb-4395-88c9-0a6dd2b367d0&status=success",
      cancel_url: "http://localhost:5173/p/animaskazo?orderId=08ffceae-f0fb-4395-88c9-0a6dd2b367d0&status=success"
    },
    webhooks: {
