...
const BundleSelectionModal = ({ isOpen, onClose, product, onConfirm, editingItem, onDelete }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Configurar ${originalName}`}>
      <div className="p-6 max-h-[80vh] overflow-y-auto">
        ...
        {product.bundleSlots?.map(slot => {
          ...
          return (
            <div key={slot.id} className="mb-6 pb-6 border-b border-gray-100 last:border-0 last:pb-0">
                ...
                {slot.options?.map(opt => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {opt.priceModifier > 0 && (
                        <span className="text-xs font-bold text-blue-600 shrink-0 bg-blue-50 px-2 py-0.5 rounded-full">
                        ...
                        {selectedOptionObj.ingredients.filter(i => i.isExtra).map(ing => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex items-center justify-between px-3 py-2 border rounded-lg text-xs transition-all text-left ${
                                isIngSelected 
