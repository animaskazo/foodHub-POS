    ...
    try {
      ...
      if (id) {
        ...
        setDeliveryData({
          ...
          delivery_radius_km: orgData.delivery_radius_km || 5,
  ...
  const handleSaveDelivery = async () => {
    ...
    try {
      await updateOrganizationDetails(orgId, {
        ...
        delivery_radius_km: deliveryData.delivery_radius_km,
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-64 shrink-0">
            <div className="bg-white rounded-2xl border border-gray-200 p-3 space-y-1">
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[15px] font-semibold transition-colors cursor-pointer ${
                  activeTab === 'delivery' ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'
                }`}
              >
          ...
          <div className="flex-1 bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            {activeTab === 'delivery' && (
              <div className="p-6 md:p-8 space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Configuración de Delivery Propio</h3>
                  <p className="text-sm text-gray-500">Define tu zona de reparto y tarifas para recibir pedidos a domicilio.</p>
                </div>
