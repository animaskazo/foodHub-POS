...
python -m PyInstaller --onefile --name "FoodHubPrint" --console --add-data "app.py;." --add-data "printer_service.py;." --add-data "requirements.txt;." --hidden-import "flask" --hidden-import "waitress" --hidden-import "fpdf" --collect-submodules "pystray" app.py
if errorlevel 1 (
